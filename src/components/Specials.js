...
export default function Projects() {
  return (
    <MotionAnimate
      ...
      <h2 className=" mx-10  title-font text-center sm:text-xl text-xl mb-1 font-bold animate-text t py-5 text-llgreen transition duration-300 delay-150">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</h2>
      <div className="grid grid-cols-1 gap-4 justify-items-center">
      <button className="border rounded text-center py-2 mb-2 text-sm font-medium  text-llblack bg-llyellow hover:bg-llred hover:shadow-llyellow shadow-xl active:bg-llred  transition duration-100 delay-150">
              <a
                href="#Menu"
